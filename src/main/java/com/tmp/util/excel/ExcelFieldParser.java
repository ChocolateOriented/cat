package com.tmp.util.excel;

import com.google.common.collect.Lists;
import com.tmp.util.Reflections;
import com.tmp.util.excel.annotation.ExcelField;
...
public class ExcelFieldParser {
	...
	private String value2String(Object val, Class<?> fieldType) {
		...
		if (val == null) {
			...
			stringVal = DateFormatUtils.format((Date)val,"yyyy-MM-dd HH:mm:ss");
		} else {
			try {
