...
//	private  String callResultDesc;
	...
	public String getDialTimeStart() {
		SimpleDateFormat sd=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
		return this.dialTimeStart == null ? null : sd.format(new Date(this.dialTimeStart));
	}
	...
	public String getDialTimeEnd() {
		SimpleDateFormat sd=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
		return this.dialTimeEnd == null ? null : sd.format(new Date(this.dialTimeEnd));
	}
